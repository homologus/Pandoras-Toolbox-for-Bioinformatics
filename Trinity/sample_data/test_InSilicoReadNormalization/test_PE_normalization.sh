...
../../util/insilico_read_normalization.pl --JM 2G --left reads.left.fq --right reads.right.fq --seqType fq --max_cov 5 --pairs_together --no_cleanup --CPU 4 --tmp_dir_name tmp_PE_norm_dir
