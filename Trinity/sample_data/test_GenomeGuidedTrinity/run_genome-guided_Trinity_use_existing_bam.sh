...
../../Trinity --left top100k.Left.fq --right top100k.Right.fq --jaccard_clip --genome top100k.genome --genome_guided_max_intron 1000 --genome_guided_use_bam SP2.chr.bam --JM 1G --seqType fq --output test_GG_use_bam_outdir
