...
static const char s_DefaultRunpath[] = "/home/msamanta/Electrophorus-Toolbox/NCBI-BLAST/ReleaseMT/lib";
...
static const char s_BuildFeatures[] = "GCC MT LFS DLL unix WinMain Linux Z BZ2 PCRE GCRYPT GNUTLS OPENSSL KRB5 CURL MySQL BerkeleyDB PYTHON Boost.Program-Options Boost.Spirit Boost.Test.Included Boost.Threads EXPAT LIBXML JPEG PNG FreeType cgi local_lbsm connext ncbi_crypt serial objects dbapi app algo -KCC -ICC -VisualAge -CompaqCompiler -Cray -WorkShop -MIPSpro -MSVC -DLL_BUILD -MaxDebug -MSWin -AIX -BSD -Cygwin -CygwinMT -Darwin -XCODE -IRIX -OSF -Solaris -MacOS -in-house-resources -PubSeqOS -JDK -Ncbi-JNI -check -Valgrind -LimitedLinker -UUID -FUSE -LocalZ -LocalBZ2 -LZO -LocalPCRE -Sybase -DBLib -FreeTDS -BerkeleyDB++ -ODBC -PYTHON23 -PYTHON24 -PYTHON25 -PERL -Boost.Filesystem -Boost.Iostreams -Boost.Regex -Boost.System -Boost.Test -C-Toolkit -OpenGL -MESA -GLUT -GLEW -wxWidgets -wx2.8 -Fast-CGI -LocalSSS -LocalMSGMAIL2 -SSSUTILS -LocalNCBILS -NCBILS2 -SSSDB -SP -ORBacus -ICU -SABLOT -LIBXSLT -LIBEXSLT -Xerces -Xalan -Zorba -SQLITE3 -SQLITE3ASYNC -OECHEM -SGE -MUPARSER -HDF5 -TIFF -UNGIF -GIF -XPM -FTGL -MAGIC -MIMETIC -GSOAP -AVRO -MONGODB -bdb -ctools -gui -gbench";
